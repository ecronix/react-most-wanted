...
module.exports.runTest = function (driver) {
  driver.get('http://www.react-most-wanted.com').then(function () {
    ...
    var signIn = driver.wait(webdriver.until.elementLocated(webdriver.By.className('firebaseui-id-submit firebaseui-button mdl-button mdl-js-button mdl-button--raised mdl-button--colored')))
